...
\begin{itemize}
	...
	\begin{itemize}
		\item Let $\mu$ be a finite measure in $(\R, \B(\R))$ . Define $\psi$ as $$\psi(t) = \exp \bigg( \int_{-\infty}^\infty \frac{e^{itx}-1-itx}{x}\, d\mu(x) \bigg) $$ Then $\psi$ is a characteristic function of an infinite divisible distribution with mean $0$ and variance $\mu(\R)$ .
